...
public class PathfinderItemNew extends Item {
    public PathfinderItemNew(Properties pProperties) {
        super(pProperties);
    }
    ...
    public List<BlockPos> findGlass(BlockPos initPos, Level level) {        // pack your bags
